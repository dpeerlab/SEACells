...
def get_compactness(ad, per_metacell=True, low_density_cells=False):
    """
    ...
    if low_density_cells:
        if 'density' not in ad.uns['metacell_metrics']:
            ...
            get_density(ad, nth_neighbor=150)
...
def get_separation(ad, nbr=1, per_metacell=True, low_density_cells=False):
    """
